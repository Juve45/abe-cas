...
typdef _public_param_SSBM_ABE[1] public_param_SSBM_ABE;
...
struct _compartmented_access_str {
	int n, t, comp_number;
	int * comp_size, * comp_threshold;
	int ** compartments;
};

struct _decryption_key_SSBM_ABE {
	int n;
	element_t * a1, * a2;
};
